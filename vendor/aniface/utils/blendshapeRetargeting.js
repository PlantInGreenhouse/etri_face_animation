 ...
 */
export const DEFAULT_BLENDSHAPE_MULTIPLIERS = {
    // Eyebrows
    browOuterUpLeft: 1.2,
 ...
 * ```
 */
export function retargetBlendshapes(categories, customMultipliers) {
    const multipliers = {
 ...
 * ```
 */
export function dampenBlendshapes(currentValues, newValues, dampeningFactor = 0.3) {
    const dampened = new Map();
 ...
 * ```
 */
export function filterBlendshapesByThreshold(blendshapes, threshold = 0.05) {
 ...
 * ```
 */
export function mapBlendshapeNames(blendshapes, nameMapping) {
 ...
 * ```
 */
export function combineBlendshapes(blendshapes, combinations, combineMethod = 'average') {
...
//# sourceMappingURL=blendshapeRetargeting.js.map