    ...
    applyMatrix(matrix, options = {}) {
        ...
        if (this.options.fullBodyAvatar && this.headBone) {
            ...
            if (this.options.axisMapping === 'quickrig') {
                ...
                if (this.neckBone) {
                    this.neckBone.rotation.set(y / 5, // Yaw
                    z / 5, // Roll
                ...
                if (this.spine2Bone) {
                    this.spine2Bone.rotation.set(y / 10, // Yaw
                    z / 10, // Roll
                    x / 10 // Pitch
                    );
                }
                ...
                // Neck: 20% of rotation with slight offset (if available)
                if (this.neckBone) {
                    this.neckBone.rotation.set(x / 5 + 0.3, // Pitch with offset
                    y / 5, // Yaw
                    z / 5 // Roll
                    );
                }
                // Spine2: 10% of rotation for subtle body follow (if available)
                if (this.spine2Bone) {
                    this.spine2Bone.rotation.set(x / 10, // Pitch
                    y / 10, // Yaw
                    z / 10 // Roll
                    );
                }
