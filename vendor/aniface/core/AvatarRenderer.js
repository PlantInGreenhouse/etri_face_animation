...
export class AvatarRenderer {
    ...
    setupScene() {
        ...
        this.camera = new THREE.PerspectiveCamera(this.config.cameraConfig.fov, aspect, 0.1, 1000);
        ...
        const ambientLight = new THREE.AmbientLight(0xffffff, this.config.lightingConfig.ambientIntensity);
        this.scene.add(ambientLight);
        // Main directional light (key light)
        const directionalLight = new THREE.DirectionalLight(0xffffff, this.config.lightingConfig.directionalIntensity);
